...
public class TestddSlick {
	...
	public void init() {
		...
		option1Item2.put("imageSrc",
				"http://dl.dropbox.com/u/40036711/Images/twitter-icon-32.png");
	...
	public Object onSelectedElement(
			@RequestParameter(value = "value", allowBlank = true) String value,
		...
		// http://designwithpc.com/Plugins/ddSlick#demo
		options1.put("ddSelectText", "Select your color");
		options1.put("ddDefaultSelectedIndex",
				valueOther.equalsIgnoreCase("Green") ? 1 : 0);
		options1.put("ddImagePosition", "left");
		options1.put("ddTruncateDescription ", true);
		options1.put("ddBackground ", "#66A3C7");
		options1.put("ddWidth", 260);
