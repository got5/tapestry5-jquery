...
public class FlexSliderStack implements JavaScriptStack {
	...
	public FlexSliderStack(
		...
		javaScriptStack = F
				.flow("${assets.path}/components/flexslider/jquery.flexslider.js",
						"${assets.path}/components/flexslider/flexslider.js")
				.map(pathToAsset).toList();

		final Mapper<String, StylesheetLink> pathToStylesheetLink = F.combine(
				pathToAsset, JQueryUtils.assetToStylesheetLink);
		cssStack = F
				.flow("${assets.path}/components/flexslider/flexslider.css")
