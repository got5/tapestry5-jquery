...
public class JQueryModule {
	...
	public static void contributeJavaScriptStackSource(
		...
		// JQueryJavaScriptStack.class);

		// configuration.addInstance(JQuerySymbolConstants.PROTOTYPE_STACK,
		// CoreJavaScriptStack.class);
		// configuration.overrideInstance(InternalConstants.CORE_STACK_NAME,
		// JQueryJavaScriptStack.class);
		if (suppressPrototype) {
			// configuration.overrideInstance("core-datefield",
			// JQueryDateFieldStack.class);
			// configuration.addInstance(FormSupportStack.STACK_ID,
			// FormSupportStack.class);
			// configuration.addInstance(FormFragmentSupportStack.STACK_ID,
			// FormFragmentSupportStack.class);
		}
		...
		configuration
				.addInstance(SuperfishStack.STACK_ID, SuperfishStack.class);
		// configuration.addInstance(AjaxUploadStack.STACK_ID,
		// AjaxUploadStack.class);
		// configuration.addInstance(GalleryStack.STACK_ID, GalleryStack.class);
		// configuration.addInstance(DataTableStack.STACK_ID,
		// DataTableStack.class);
		// configuration.addInstance(InPlaceEditorStack.STACK_ID,
		// InPlaceEditorStack.class);
		// configuration.addInstance(PlaceholderStack.STACK_ID,
		// PlaceholderStack.class);
		// configuration.addInstance(DDSlickStack.STACK_ID, DDSlickStack.class);
		// configuration.addInstance(JScrollPaneStack.STACK_ID,
		// JScrollPaneStack.class);
		// configuration.addInstance(FlexSliderStack.STACK_ID,
		// FlexSliderStack.class);
	}
	...
	public void addJavaScriptFilesRules(
			MappedConfiguration<String, String> configuration) {

		// configuration.add("t5-prototype.js",
		// "${tapestry.jquery.path}/t5-jquery.js");
		// configuration.add("tapestry.js",
		// "${tapestry.jquery.path}/tapestry-jquery.js");
		// configuration.add("t5-console.js",
		// "${tapestry.jquery.path}/t5-console-jquery.js");
		// configuration.add("t5-dom.js",
		// "${tapestry.jquery.path}/t5-dom-jquery.js");
		// configuration.add("t5-alerts.js",
		// "${tapestry.jquery.path}/t5-alerts-jquery.js");
		// configuration.add("t5-ajax.js",
		// "${tapestry.jquery.path}/t5-ajax-jquery.js");
		// configuration.add("tree.js",
		// "${tapestry.jquery.path}/t5-tree-jquery.js");
	...
	@Advise
	@ClasspathProvider
	public static void modifyJsfile(MethodAdviceReceiver receiver,
